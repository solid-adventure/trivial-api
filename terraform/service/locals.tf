...
locals {
  ...
  ecs_subnet_ids         = data.terraform_remote_state.whiplash-regional.outputs.internal_subnet_ids
  ...
  allow_internal_vpc_traffic_security_group = data.terraform_remote_state.trivial-infra.outputs.allow_internal_vpc_traffic_security_group_arn
